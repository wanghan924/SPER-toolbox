function PP = Pattern_extraction(xy,NN,XY,R_data)
...
function output = core(XY,R_data)
XY1 = XY;
RP = R_data;
...
[~,cmeans] = kmeans(meas,eva.OptimalK,'dist','sqeuclidean','replicates',10);
